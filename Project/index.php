...
<input type="radio" id="Higher-than" name="greater_less_year" value="Higher-than" checked="checked">
<label for="Higher-than">After</label><br>
<input type="radio" id="Lower-than" name="greater_less_year" value="Lower-than">
<label for="Lower-than">Before</label><br>
<input type="radio" id="At-year" name="greater_less_year" value="At-year">
<label for="At-year">Exactly</label><br>
